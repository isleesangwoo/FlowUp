...
$(document).ready(function() {
	...
	$("button#openModal").click(function(){
	    ...
	    $("input:text[name='directCall']").blur(function(e){
	    	...
	    	const regExp = /^0([0|1|6|7|8|9|4|3|1]{1,2}?)?([0-9]{3,4})?([0-9]{4})$/;
	    	const bool = regExp.test($(e.target).val());
	    ...
	    const companyAddress = $("input:text[name='companyAddress']").val().trim();
	    if(companyAddress == ""){
  	  	...
  	  	success:function(json){
  	  		...
  	  		for(let i=0;i<json.length;i++){
  	  			...
  	  			v_html+="<tr>"
		  			  ...
		  			  +		"<td class='tdcss'><span class='tabletitle' name='data_phoneNo'>"+json[i].PHONENO+"</span></td>"
		  			  +		"<td class='tdcss'><span class='tabletitle data_department' name='data_department'>"+json[i].DEPARTMENT+"</td>"
		  			  +		"<td class='tdcss'><span class='tabletitle data_company' name='data_company'>"+json[i].COMPANY+"</span></td>"
