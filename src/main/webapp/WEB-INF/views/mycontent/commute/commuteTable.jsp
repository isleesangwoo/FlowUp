		...
		<form name="commuteTableFrm">	
			...
			<div class="ml-1 mr-1 mb-5">
				...
				<c:if test="${requestScope.departmentNo != 'all'}">
					...
					<div style="font-size:14pt;">부서 근태현황 ( ${requestScope.departmentNo} )</div>
			...
			<div>
				...
				<div class="mb-1" style="display:flex" >
					<div style="margin:0 auto 0 0; display:flex; gap:8px;">
						...
						<input type="text" name="searchWord" value="" style=""/>
				...
				<div>
					<table class="table table-striped table-hover">
						<thead class="thead text-center" style="font-size:12pt;">
							<tr>
								<th>이름</th>
								<th>누적 근무시간</th>
								<th>1주</th>
